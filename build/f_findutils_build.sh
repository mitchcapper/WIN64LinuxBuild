...
BLD_CONFIG_CONFIG_CMD_ADDL="--disable-nls" #--disable-nls --enable-static
BLD_CONFIG_BUILD_MSVC_RUNTIME_INFO_ADD_TO_C_AND_LDFLAGS=1
#BLD_CONFIG_BUILD_DEBUG=1
BLD_CONFIG_GNU_LIBS_ADDL=("poll-h")
BLD_CONFIG_BUILD_DEBUG_ADDL_CFLAGS="" #removing the -DDEBUG ddefine as no idea where find_pred_name should come from 
